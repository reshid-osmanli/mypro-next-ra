      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 lg:px-8">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          {isAuthenticated ? (
            ...
            <Link href="/login" className="inline-flex h-10 items-center gap-2 rounded-2xl border border-zinc-200 bg-white px-3 py-0 text-sm font-black text-zinc-900 shadow-sm transition hover:-translate-y-0.5 hover:border-qatar-200 hover:bg-white" aria-label={text(copy.login)}>
              <GoogleIcon />
